...
/**
 * Class CreateResearchPermitNotification
 */
class CreateResearchPermitNotification extends Notify
{
    private $training;
	private $message;
	private $url;
    ...
    public function __construct($training = null)
    {
		...
		$this->message = "Research Permit Letter";
		$this->url = site_url("training/");
    }
