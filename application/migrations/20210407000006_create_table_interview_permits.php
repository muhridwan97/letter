...
class Migration_Create_table_interview_permits extends CI_Migration
{
    public function up()
    {
        ...
        ->add_field('CONSTRAINT fk_kaprodi_ip FOREIGN KEY (id_kaprodi) REFERENCES ref_lecturer(id) ON DELETE CASCADE ON UPDATE CASCADE')
        ->add_field('CONSTRAINT fk_pembimbing_ip FOREIGN KEY (id_pembimbing) REFERENCES ref_lecturer(id) ON DELETE CASCADE ON UPDATE CASCADE')
