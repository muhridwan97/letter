                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="sort_by" id="sort_by" required>
                                    ...
                                    $sortBy = [
                                        ...
                                        'last_approved_at' => 'LAST APPROVED',
                                        'last_notify_vendor_at' => 'LAST NOTIFY VENDOR',
                                        ...
                                        'last_submit_to_manager_at' => 'LAST SUBMIT TO MANAGER',
                                        'last_vendor_selected_at' => 'LAST VENDOR SELECTION',
                                        'no_purchase' => 'NO PURCHASE',
                                        'purchase_date' => 'PURCHASE DATE',
                                        'tax' => 'TAX',
                                        'tax_percentage' => 'TAC PERCENTAGE',
                                        'miscellaneous_expense' => 'MISCELLANEOUS EXPENSE',
                                        'delivery_cost' => 'DELIVERY COST',
                                        'total_item_type' => 'TOTAL ITEM TYPE',
