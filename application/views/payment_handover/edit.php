<form action="<?= site_url('purchasing/payment_handover/update') ?>" method="POST" id="form-upload-handover" enctype="multipart/form-data">
    <?= _csrf() ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker" id="handover_date" name="handover_date" required maxlength="50" autocomplete="off"
                               value="<?= set_value('handover_date',date('d/m/y',strtotime($paymentHandover['handover_date']))) ?>" placeholder="Handover Date">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" value="<?= $paymentHandover['document'] ?>" class="form-control file-upload-info" disabled placeholder="Upload file">
    ...
    <div class="card grid-margin">
        <div class="card-body d-flex justify-content-between">
            ...
            <button type="submit" class="btn btn-success" data-toggle="one-touch" data-touch-message="Updating...">Update</button>
        </div>
    </div>
</form>
