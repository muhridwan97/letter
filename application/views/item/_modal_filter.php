        ...
        <div class="modal-content">
            <form action="<?= site_url(uri_string()) ?>" id="form-filter">
                        ...
                        <div class="col-8 col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="sort_by" id="sort_by" required>
                                    ...
                                    <option value="no_item"<?= set_select('sort_by', 'no_item', get_url_param('sort_by') == 'no_item') ?>>
                                        NO ITEM
                                    </option>
                                    <option value="item_name"<?= set_select('sort_by', 'item_name', get_url_param('sort_by') == 'item_name') ?>>
                                        ITEM NAME
                                    </option>
									<option value="unit"<?= set_select('sort_by', 'unit', get_url_param('sort_by') == 'unit') ?>>
										UNIT
									</option>
									<option value="brand"<?= set_select('sort_by', 'brand', get_url_param('sort_by') == 'brand') ?>>
										BRAND
									</option>
                                </select>
                                <?= form_error('sort_by'); ?>
                ...
                <div class="modal-footer">
                    <a href="<?= site_url('master/item') ?>" class="btn btn-sm btn-secondary">
                        RESET
                    </a>
