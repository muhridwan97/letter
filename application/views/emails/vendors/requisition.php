                        ...
                        <table style="<?php echo $style['email-body_inner'] ?>" align="center" width="700"
                            ...
                            <tr>
                                <td style="<?php echo $fontFamily ?> <?php echo $style['email-body_cell'] ?>">
                                    <!-- Greeting -->
                                    <h1 style="<?php echo $style['header-1'] ?>">Transcon Requisition</h1>
                                    ...
                                    <p style="<?php echo $style['paragraph'] ?>">
                                        <?= get_setting('company_name') ?> demand goods/services,
                                        <b>PLEASE SEND YOUR OFFER / QUOTATION TO US</b> by following detail bellow:
                                    </p>
                                    ...
                                    <p><b>USE BUTTON APPLY OFFER TO SEND YOUR QUOTATION<br>(DO NOT REPLY DIRECTLY IN THIS EMAIL SENDER)</b></p>
                                        ...
                                        <tr>
                                            <td style="<?php echo $fontFamily ?>">
                                                <p style="<?php echo $style['paragraph-sub'] ?>">
                                                    ...
                                                    <a href="mailto:<?= $vendor['email']; ?>" style="<?php echo $style['anchor'] ?>">
                                                        <?= $vendor['email']; ?>
                                                    </a>
                                                </p>
                                            </td>
