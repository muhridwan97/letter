                        ...
                        <table style="<?php echo $style['email-body_inner'] ?>" align="center" width="700"
                            ...
                            <tr>
                                <td style="<?php echo $fontFamily ?> <?php echo $style['email-body_cell'] ?>">
                                    <!-- Greeting -->
                                    <h1 style="<?php echo $style['header-1'] ?>">Purchase Order</h1>
                                    ...
                                    <p style="<?php echo $style['paragraph'] ?>">
                                        Setelah melakukan berbagai pertimbangan terhadap penawaran yang telah dikirimkan,
                                        Transcon indonesia memilih anda sebagai vendor penyedia barang/jasa
                                    ...
                                    <table style="<?php echo $style['paragraph'] ?>" width="100%">
                                        ...
                                        <tr>
                                            <td>No Order</td>
                                            <td><b><?= $noPurchase ?></b></td>
                                        </tr>
                                        <tr>
                                            <td>Expected Delivery</td>
                                            <td><b><?= format_date($purchaseOffer['lead_time'], 'd F Y') ?></b></td>
                                        </tr>
                                    </table>
                                    ...
                                    <table style="<?php echo $style['table'] ?>" width="100%">
                                        <tr style="border-bottom: 1px solid #aaaaaa">
                                            ...
                                            <th align="left" style="padding: 4px">Price</th>
                                        </tr>
                                        <?php $no = 1; ?>
                                        <?php foreach ($purchaseOfferItems as $item): ?>
                                            <tr>
                                                ...
                                                <td style="padding: 4px"><?= numerical($item['quantity']) ?></td>
                                                <td style="padding: 4px">Rp. <?= numerical($item['price']) ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </table>
                                    ...
                                    <p style="<?php echo $style['paragraph'] ?>">
                                        Berikut kami lampirkan form pembelian melalui attachment (PDF) dengan detail total harga dan biaya lain - lain, untuk informasi
                                        lebih lanjut silahkan hubungi bagian purchasing <b>Transcon Indonesia</b> di <?= get_setting('email_purchasing'); ?>.
                                    </p>
                                    ...
                                    <p style="<?php echo $style['paragraph'] ?>">
                                        Regards,<br>
                                        <b>Purchasing Transcon Indonesia</b>
                                    </p>

                                    <p><b>DO NOT REPLY REQUISITION OFFER IN THIS EMAIL</b></p>
