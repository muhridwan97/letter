<form action="<?= site_url('master/employee/save') ?>" method="POST" enctype="multipart/form-data" id="form-employee">
    <?= _csrf() ?>
        ...
        <div class="card-body">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" required maxlength="50"
                               value="<?= set_value('name') ?>" placeholder="Employee name">
                        <?= form_error('name') ?>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="no_employee" name="no_employee" required maxlength="20"
                               value="<?= set_value('no_employee', $employeeNo) ?>" placeholder="Employee unique ID">
                        ...
                        <select class="custom-select" id="department" name="department" required>
                            ...
                            <?php foreach ($departments as $department): ?>
                                <option value="<?= $department['id'] ?>"
                                    <?= set_select('department', $department['id']) ?>>
                        ...
                        <select class="custom-select" id="parent_employee" name="parent_employee">
                            ...
                            <?php foreach ($parentEmployees as $parentEmployee): ?>
                                <option value="<?= $parentEmployee['id'] ?>"
                                    <?= set_select('parent_employee', $parentEmployee['id']) ?>>
                                    <?= $parentEmployee['name'] ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="position" name="position" required maxlength="50"
                               value="<?= set_value('position') ?>" placeholder="Eg. Admin, Programmer">
                        <?= form_error('position') ?>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
                    <div class="form-group">
                        ...
                        <select class="custom-select" id="position_level" name="position_level" required>
                            ...
                            <option value="STAFF"<?= set_select('position_level', 'STAFF') ?>>STAFF</option>
                            <option value="SUPERVISOR"<?= set_select('position_level', 'SUPERVISOR') ?>>SUPERVISOR</option>
                            <option value="MANAGER"<?= set_select('position_level', 'MANAGER') ?>>MANAGER</option>
                            <option value="DIRECTOR"<?= set_select('position_level', 'DIRECTOR') ?>>DIRECTOR</option>
                        </select>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker" id="enter_date" name="enter_date" required maxlength="50"
                               value="<?= set_value('enter_date') ?>" placeholder="Date employee is hired" autocomplete="off">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker" id="quit_date" name="quit_date" maxlength="50"
                               value="<?= set_value('quit_date') ?>" placeholder="Date employee resign" autocomplete="off">
                                ...
                                <div class="form-check mt-2">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="gender" id="gender_male" value="male"
                                            <?= set_radio('gender', 'male', true) ?>> Male
                                ...
                                <div class="form-check mt-2">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="gender" id="gender_female" value="female"
                                            <?= set_radio('gender', 'female', true) ?>> Female
                                        <i class="input-helper"></i>
                                    </label>
                                </div>
                            </div>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group col-xs-12">
                            <input type="text" id="photo-title" class="form-control file-upload-info" disabled placeholder="Upload photo">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="custom-select" id="company" name="company" required>
                            ...
                            <option value="TRANSCON INDONESIA"<?= set_select('company', 'TRANSCON INDONESIA') ?>>TRANSCON INDONESIA</option>
                            <option value="BLBJ"<?= set_select('company', 'BLBJ') ?>>BLBJ</option>
                            <option value="ISPM"<?= set_select('company', 'ISPM') ?>>ISPM</option>
                            <option value="OTHER"<?= set_select('company', 'OTHER') ?>>OTHER</option>
                        </select>
                        <?= form_error('company') ?>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="work_location" name="work_location" required maxlength="50"
                               value="<?= set_value('work_location') ?>" placeholder="Work location">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tax_no" name="tax_no" maxlength="50"
                               value="<?= set_value('tax_no') ?>" placeholder="Tax no">
                        <?= form_error('tax_no') ?>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tax_address" name="tax_address" maxlength="50"
                               value="<?= set_value('tax_address') ?>" placeholder="Tax address">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="id_card_no" name="id_card_no" maxlength="50"
                               value="<?= set_value('id_card_no') ?>" placeholder="ID card no">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="id_card_address" name="id_card_address" maxlength="50"
                               value="<?= set_value('id_card_address') ?>" placeholder="ID card address">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="social_security_no" name="social_security_no" maxlength="50"
                               value="<?= set_value('social_security_no') ?>" placeholder="Social security no">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="health_insurance_no" name="health_insurance_no" maxlength="50"
                               value="<?= set_value('health_insurance_no') ?>" placeholder="Health insurance no">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="place_of_birth" name="place_of_birth" maxlength="50"
                               value="<?= set_value('place_of_birth') ?>" placeholder="Place of your birth">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker" id="date_of_birth" name="date_of_birth" maxlength="50"
                               value="<?= set_value('date_of_birth') ?>" placeholder="Your birthday" autocomplete="off">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="contact_phone" name="contact_phone" maxlength="50"
                               value="<?= set_value('contact_phone') ?>" placeholder="Contact phone">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="contact_mobile" name="contact_mobile" maxlength="50"
                               value="<?= set_value('contact_mobile') ?>" placeholder="Contact mobile">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="description" name="description" maxlength="500"
                          placeholder="Enter employee description"><?= set_value('description') ?></textarea>
                <?= form_error('description') ?>
            </div>
            <div class="d-flex justify-content-between mt-3">
                <button onclick="history.back()" type="button" class="btn btn-light">Back</button>
                <button type="submit" class="btn btn-success mr-2" data-toggle="one-touch" data-touch-message="Saving...">Save Employee</button>
            </div>
        </div>
    </div>
</form>
