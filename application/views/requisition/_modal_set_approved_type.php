<div class="modal fade" id="modal-set-approved-type" tabindex="-1" role="dialog" aria-labelledby="Set approved type Requisition" aria-hidden="true">
        ...
        <div class="modal-content">
            <form action="#" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-sm btn-success" data-toggle="one-touch" data-touch-message="Updating...">Approve</button>
                </div>
            </form>
        </div>
    </div>
