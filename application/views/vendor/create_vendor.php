<form action="<?= site_url('master/vendor-create/update/' . $vendor['id']) ?>" method="POST" id="form-vendor" enctype="multipart/form-data">
    <?= _csrf() ?>
    <div class="card grid-margin">
        <div class="card-body">
            <h4 class="card-title">Company Identity</h4>
            <div class="row">
                <div class="col-md-6">
