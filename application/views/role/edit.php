                    ...
                    <?php foreach ($permissions as $permission): ?>
                        ...
                        <?php if($lastGroup != $module): ?>
                            ...
                            <div class="col-12 mt-3">
                                <hr>
                                <h4 class="mt-2">
                                    <span class="form-check form-check-flat mt-0">
                        ...
                        <div class="col-sm-3">
                            <div class="form-check form-check-flat mt-2">
                                <label class="form-check-label">
                                    <input type="checkbox" class="<?= $lastGroupName ?> form-check-input"<?= set_checkbox('permissions[]', $permission['id'], $hasPermission); ?>
