        ...
        <div class="modal-content">
            <form action="<?= site_url(uri_string()) ?>" id="form-filter">
                        ...
                        <div class="col-8 col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="sort_by" id="sort_by" required>
                                    ...
                                    <option value="total_vendor"<?= set_select('sort_by', 'total_vendor', get_url_param('sort_by') == 'total_vendor') ?>>
                                        TOTAL VENDOR
                                    </option>
                                </select>
                                <?= form_error('sort_by'); ?>
                ...
                <div class="modal-footer">
                    <a href="<?= site_url('master/category') ?>" class="btn btn-sm btn-secondary">
                        RESET
                    </a>
