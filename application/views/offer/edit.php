<form action="<?= site_url('purchasing/offer/update/' . $purchaseOffer['id']) ?>" method="POST" id="form-offer" enctype="multipart/form-data">
    <?= _csrf() ?>
    <?= _method('put') ?>
        ...
        <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="requisition" id="requisition" data-placeholder="Select requisition" required>
                            ...
                            <?php foreach ($requisitions as $requisition): ?>
                                <option value="<?= $requisition['id'] ?>"<?= set_select('requisition', $requisition['id'], $requisition['id'] == $purchaseOffer['id_requisition']) ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="vendor" id="vendor" data-placeholder="Select vendor" required>
                            ...
                            <?php foreach ($vendors as $vendor): ?>
                                <option value="<?= $vendor['id'] ?>"<?= set_select('vendor', $vendor['id'], $vendor['id'] == $purchaseOffer['id_vendor']) ?>>
                                    <?= $vendor['vendor'] ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
            ...
            <div class="form-row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker" id="lead_time" name="lead_time" required maxlength="50" autocomplete="off"
                               value="<?= set_value('lead_time', format_date($purchaseOffer['lead_time'], 'd/m/Y')) ?>" placeholder="Expected the items has arrived">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="top" name="top" required min="0" max="100"
                               placeholder="Terms of payment" value="<?= set_value('top', $purchaseOffer['top']) ?>">
                        <?= form_error('top') ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control file-upload-info" value="<?= $purchaseOffer['document'] ?>" disabled placeholder="Upload file">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="description" name="description" maxlength="500"
                          placeholder="Purchase offer note"><?= set_value('description', $purchaseOffer['description']) ?></textarea>
    ...
    <div class="card grid-margin">
        <div class="card-body">
            ...
            <table class="table responsive" id="table-item">
                ...
                <tbody>
                <?php $takenItems = set_value('taken_items', $purchaseOfferItems); ?>
    ...
    <div class="card grid-margin">
        <div class="card-body">
            ...
            <table class="table" id="table-taken">
                <thead>
                <tr>
                    <th>No</th>
                    <th>Item Name</th>
                ...
                <?php foreach ($takenItems as $index => $item): ?>
                    <tr>
                        ...
                        <td class="label-item"><?= $item['item_name'] ?></td>
                        <td class="label-brand"><?= if_empty($item['brand'], '-') ?></td>
                        <td class="label-quantity"><?= numerical($item['quantity']) ?></td>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control currency" id="offer_discount_goods" name="offer_discount_goods"
                               placeholder="Discount of all goods" value="Rp. <?= set_value('offer_discount_goods', numerical($purchaseOffer['offer_discount_goods'])) ?>">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control currency" id="offer_discount_services" name="offer_discount_services"
                               placeholder="Discount of all services" value="Rp. <?= set_value('offer_discount_services', numerical($purchaseOffer['offer_discount_services'])) ?>">
    ...
    <div class="card grid-margin">
        <div class="card-body d-flex justify-content-between">
            ...
            <button type="submit" class="btn btn-primary" data-toggle="one-touch" data-touch-message="Updating...">Update Purchase Offer</button>
        </div>
    </div>
</form>
